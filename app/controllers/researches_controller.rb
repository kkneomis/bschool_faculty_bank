class ResearchesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @research.update(research_params)
          format.html { redirect_to current_user, notice: 'Research was successfully updated.' }
  ...
  def destroy
    @research.destroy
    respond_to do |format|
        format.html { redirect_to current_user, notice: 'Research was successfully destroyed.' }
  ...
  private
    ...
    def research_params
      params.require(:research).permit(:name, :user_id)
    end
end
